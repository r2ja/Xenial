...
const Sidebar = () => {
  ...
  const handlePostCreated = () => {
    // Optionally refresh the current page or update the post list
      ...
      <div className="bg-xenial-dark text-white w-44 h-screen flex flex-col fixed left-0 top-0 border-r border-gray-700">
        ...
        <div className="p-4 mt-auto space-y-2 font-body">
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 p-2 rounded-lg bg-xenial-blue text-white hover:bg-xenial-blue-light transition-colors"
          >
